      ...
      <View style={styles.chapters}>
        {currentBook.chapters.map((entry) => {
          ...
          return <View
            ...
            style={[styles.chapter, read && styles.chapterLit]}
          >
...
const styles = StyleSheet.create({
  ...
  chapter: { width: CHAPTER_SIZE, minHeight: CHAPTER_SIZE, alignItems: 'center', justifyContent: 'center', borderRadius: theme.radius.chip, borderWidth: theme.control.hairline, borderColor: theme.colors.border, backgroundColor: theme.colors.surface, paddingVertical: theme.spacing.xxs },
  ...
  chapterReaders: { color: theme.colors.white, fontSize: theme.type.micro.size, lineHeight: theme.type.micro.line, fontWeight: '700' },
