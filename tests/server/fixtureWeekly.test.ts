...
describe('controlled fixture weekly sync oracle', () => {
  it('uses two fictitious fixed members, two dates and four person-tasks', async () => {
    ...
    expect(progress.body.weekly).toMatchObject({ completed: 1, target: 2, personalCompleted: 1, points: 1 });
    ...
    expect(progress.body.weekly).toMatchObject({ completed: 0, target: 2, personalCompleted: 0, points: 0 });
