...
本目錄是新session的耐久context，不取代versioned spec或source。

- `product-context.md`：使用者、產品方向、不可漂移的功能決策。
- `operations.md`：build/runtime/private依賴與安全操作邊界。
...
最新指示優先於舊對話。若本handoff與source/spec衝突，先讀最新commit與proof再判斷，不重新詢問已明確決策。
