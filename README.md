...
| 完成與積分 | 台北日期每人每天一份有效積分；今日及前六天可補登；撤銷需先確認；完成瞬間短暫「+1」 |
| 積分頁 | 最上面是目標獎品：環形進度 `72/120 分`、獎品架可點選設為目標；總積分與梯隊（滿 10 人才分梯隊）；讀經日曆：週／月（完整週會一起變深）／年（每月比例條）／全部，切換不需等待網路 |
| 靈修日記 | 讀經器右上角筆記圖示開啟半頁面板；選取經文按複製即帶入引用；獨立日記分頁管理全部內容，可匯出成 Markdown 檔分享 |
| 想要什麼獎品 | 學生提名獎品並互相投票，輔導設定積分後成為正式獎品；每人同時最多三個提名 |
| 一起走過 | 積分頁底部顯示全體讀過哪幾卷書；累計天次在成員滿 10 人後才顯示 |
